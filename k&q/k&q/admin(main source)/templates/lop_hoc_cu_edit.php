			...
			?>
						<form action="lop_hoc_code.php" method="POST">
							...
							<div class="form-group">
								<label> Mã Lớp </label>
								<input type="text" readonly name="MaLop" value="<?php echo $row['MaLop'] ?>" class="form-control">
							</div>
							<div class="form-group">
							...
							<button type="submit" name="update_lhc" class="btn btn-primary"> Thay Đổi</button>
							<a href="<?php echo '' . $_DOMAIN . 'lophoc_cu'; ?>" class="btn btn-danger"> Hủy </a>
						</form>
			<?php
					}
				}
