	...
	<div class="card shadow mb-4">
		...
		<div class="card-body">
			...
			?>
						...
						<input type="hidden" name="id_mh" value="<?php echo $id_mh ?>" class="form-control" class="form-control">
							<div class="form-group">
								<label>Lớp</label>
								<input type="hidden" name="lop" value="<?php echo $id ?>" class="form-control" class="form-control">
				...
				?>
				<a class="btn btn-info" href="<?php echo '' . $_DOMAIN . 'khoa_thilai'; ?>">Quay Lại</a>
						</form>
		</div>
	</div>
</div>