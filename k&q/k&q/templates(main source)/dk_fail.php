                ...
                <div class="card">
                    <div class="card-body">
                        <div class="blog-post">
                            ...
                            <p style="text-align:center">Email hoặc số điện thoại bạn đăng ký đã tồn tại trong hệ thống chúng tôi.</p>
                            <p style="text-align:center">Vui lòng thử lại với email hoặc số điện thoại khác.</p>
